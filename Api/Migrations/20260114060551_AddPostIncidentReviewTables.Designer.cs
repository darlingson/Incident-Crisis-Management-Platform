...
namespace Api.Migrations
{
    ...
    [Migration("20260114060551_AddPostIncidentReviewTables")]
    partial class AddPostIncidentReviewTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.ContributingFactor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PostIncidentReviewId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("PostIncidentReviewId");

                    b.ToTable("ContributingFactors");
                });

            modelBuilder.Entity("Api.Models.PostIncidentReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Api.Models.PreventiveAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Api.Models.RecoveryStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Api.Models.ReportStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Api.Models.ContributingFactor", b =>
                {
                    b.HasOne("Api.Models.PostIncidentReview", null)
                        .WithMany("ContributingFactors")
                        .HasForeignKey("PostIncidentReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
